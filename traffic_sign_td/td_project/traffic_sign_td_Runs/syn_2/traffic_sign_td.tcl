...
### Editable zone for opt_place ###
  ...
  flow_status -file place_flow.status
   # TD 6.2.168116 terminates during this optional report on this PH1P35 run.
   # Keep placement evidence from report_timing/report_area/flow_status and continue to route.
...
### Editable zone for opt_route ###
  ...
  flow_status -file route_flow.status
   # TD 6.2.168116 also terminates during the route clock-utilization report.
###################################
